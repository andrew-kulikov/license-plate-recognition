...
def detectPlatesInScene(imgOriginalScene):
    ...
    if Recognitor.showSteps == True: # show steps #######################################################
    ...
    if Recognitor.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, Recognitor.SCALAR_WHITE)
    ...
    if Recognitor.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), Recognitor.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), Recognitor.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), Recognitor.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), Recognitor.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if Recognitor.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, Recognitor.SCALAR_WHITE)
        # end if # show steps #####################################################################
